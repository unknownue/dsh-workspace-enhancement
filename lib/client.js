window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\Workspace\submodules\dsh-workspace-enhancement\src\client\side-workspaces.module.css.mjs
		const css = ".iF6NkG_action,.iF6NkG_panel{--dswsw-accent:var(--color-primary,var(--accent,var(--primary,#4a6cf7)));--dswsw-accent-fg:#fff;--dswsw-surface:var(--color-bg-elevated,var(--background,var(--card,#17181c)));--dswsw-fg:var(--color-fg,var(--foreground,#e8e9ec));--dswsw-danger:var(--color-danger,var(--destructive,#e5534b));--dswsw-surface-2:color-mix(in srgb, var(--dswsw-fg) 3%, var(--dswsw-surface));--dswsw-surface-3:color-mix(in srgb, var(--dswsw-fg) 7%, var(--dswsw-surface));--dswsw-surface-inset:color-mix(in srgb, black 10%, var(--dswsw-surface));--dswsw-line:color-mix(in srgb, var(--dswsw-fg) 8%, var(--dswsw-surface));--dswsw-border:color-mix(in srgb, var(--dswsw-fg) 14%, var(--dswsw-surface));--dswsw-border-strong:color-mix(in srgb, var(--dswsw-fg) 26%, var(--dswsw-surface));--dswsw-fg-muted:color-mix(in srgb, var(--dswsw-fg) 65%, var(--dswsw-surface));--dswsw-fg-subtle:color-mix(in srgb, var(--dswsw-fg) 38%, var(--dswsw-surface));--dswsw-accent-soft:color-mix(in srgb, var(--dswsw-accent) 13%, var(--dswsw-surface));--dswsw-danger-soft:color-mix(in srgb, var(--dswsw-danger) 12%, var(--dswsw-surface));--dswsw-danger-text:color-mix(in srgb, var(--dswsw-danger) 55%, var(--dswsw-fg));--dswsw-scrim:#090a0d94;--dswsw-shadow:0 24px 64px #00000080}@media (prefers-color-scheme:light){.iF6NkG_action,.iF6NkG_panel{--dswsw-accent:var(--color-primary,var(--accent,var(--primary,#3b5bdb)));--dswsw-surface:var(--color-bg-elevated,var(--background,var(--card,#fff)));--dswsw-fg:var(--color-fg,var(--foreground,#21242a));--dswsw-danger:var(--color-danger,var(--destructive,#c9352f));--dswsw-surface-2:color-mix(in srgb, var(--dswsw-fg) 3%, var(--dswsw-surface));--dswsw-surface-3:color-mix(in srgb, var(--dswsw-fg) 7%, var(--dswsw-surface));--dswsw-surface-inset:color-mix(in srgb, black 6%, var(--dswsw-surface));--dswsw-line:color-mix(in srgb, var(--dswsw-fg) 8%, var(--dswsw-surface));--dswsw-border:color-mix(in srgb, var(--dswsw-fg) 14%, var(--dswsw-surface));--dswsw-border-strong:color-mix(in srgb, var(--dswsw-fg) 26%, var(--dswsw-surface));--dswsw-fg-muted:color-mix(in srgb, var(--dswsw-fg) 65%, var(--dswsw-surface));--dswsw-fg-subtle:color-mix(in srgb, var(--dswsw-fg) 38%, var(--dswsw-surface));--dswsw-accent-soft:color-mix(in srgb, var(--dswsw-accent) 11%, var(--dswsw-surface));--dswsw-danger-soft:color-mix(in srgb, var(--dswsw-danger) 10%, var(--dswsw-surface));--dswsw-danger-text:color-mix(in srgb, var(--dswsw-danger) 55%, var(--dswsw-fg));--dswsw-scrim:#0f111557;--dswsw-shadow:0 24px 64px #0f111533}}.iF6NkG_action{border:1px solid var(--dswsw-border);background:var(--dswsw-surface);color:var(--dswsw-fg);cursor:pointer;white-space:nowrap;border-radius:6px;align-items:center;gap:5px;padding:4px 10px;font-family:inherit;font-size:12px;display:inline-flex}.iF6NkG_action:hover{background:var(--dswsw-surface-3);border-color:var(--dswsw-border-strong)}.iF6NkG_action svg{flex:none}.iF6NkG_panel{z-index:1000;background:var(--dswsw-scrim);font-family:var(--font-sans,ui-sans-serif, system-ui, -apple-system, \"Segoe UI\", Roboto, \"PingFang SC\", \"Microsoft YaHei\", sans-serif);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.iF6NkG_panel button,.iF6NkG_panel input,.iF6NkG_panel select{font-family:inherit}.iF6NkG_panel :focus-visible{outline:2px solid var(--dswsw-accent);outline-offset:1px}.iF6NkG_card{border:1px solid var(--dswsw-border);background:var(--dswsw-surface);width:560px;max-width:92vw;max-height:86vh;color:var(--dswsw-fg);box-shadow:var(--dswsw-shadow);border-radius:12px;flex-direction:column;gap:10px;padding:16px;font-size:13px;display:flex;overflow:auto}.iF6NkG_header{justify-content:space-between;align-items:center;gap:10px;display:flex}.iF6NkG_title{font-size:14px;font-weight:600}.iF6NkG_error{color:var(--dswsw-danger-text);overflow-wrap:anywhere;font-size:12px;line-height:1.45}.iF6NkG_list{flex-direction:column;gap:6px;max-height:240px;display:flex;overflow:auto}.iF6NkG_loading,.iF6NkG_empty{color:var(--dswsw-fg-muted);font-size:12px}.iF6NkG_empty{line-height:1.55}.iF6NkG_row{border:1px solid var(--dswsw-border);background:var(--dswsw-surface-2);border-radius:7px;align-items:center;gap:8px;padding:6px 8px;display:flex}.iF6NkG_rowIcon{color:var(--dswsw-fg-muted);flex:none}.iF6NkG_itemLabel{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:180px;font-size:12px;font-weight:600;overflow:hidden}.iF6NkG_rowPath{text-overflow:ellipsis;white-space:nowrap;max-width:180px;color:var(--dswsw-fg-muted);flex:none;font-size:11px;overflow:hidden}.iF6NkG_row .iF6NkG_input{flex:auto;width:auto;min-width:0}.iF6NkG_renameButton{border:1px solid var(--dswsw-border);color:var(--dswsw-fg-muted);cursor:pointer;white-space:nowrap;background:0 0;border-radius:6px;flex:none;padding:3px 8px;font-size:11.5px}.iF6NkG_renameButton:hover{background:var(--dswsw-surface-3);border-color:var(--dswsw-border-strong);color:var(--dswsw-fg)}.iF6NkG_form{border-top:1px solid var(--dswsw-line);flex-direction:column;gap:8px;padding-top:10px;display:flex}.iF6NkG_segment{border:1px solid var(--dswsw-line);background:var(--dswsw-surface-inset);border-radius:9px;gap:3px;width:fit-content;padding:3px;display:inline-flex}.iF6NkG_segmentButton{color:var(--dswsw-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:4px 14px;font-size:12.5px;font-weight:500;display:inline-flex}.iF6NkG_segmentButton:hover:not(.iF6NkG_segmentButtonOn):not(:disabled){color:var(--dswsw-fg)}.iF6NkG_segmentButtonOn{background:var(--dswsw-surface-3);color:var(--dswsw-fg);box-shadow:inset 0 0 0 1px var(--dswsw-border-strong)}.iF6NkG_segmentButton:disabled{opacity:.55;cursor:default}.iF6NkG_fieldRow{gap:8px;display:flex}.iF6NkG_fieldRow .iF6NkG_input{flex:auto;width:auto;min-width:0}.iF6NkG_input{box-sizing:border-box;border:1px solid var(--dswsw-border);background:var(--dswsw-surface-inset);width:100%;color:var(--dswsw-fg);border-radius:7px;outline:none;padding:6px 9px;font-size:12.5px}.iF6NkG_input::placeholder{color:var(--dswsw-fg-subtle)}.iF6NkG_input:focus{border-color:var(--dswsw-accent);box-shadow:0 0 0 3px var(--dswsw-accent-soft)}.iF6NkG_select{border:1px solid var(--dswsw-border);background:var(--dswsw-surface-inset);min-width:72px;color:var(--dswsw-fg);border-radius:6px;outline:none;flex:none;padding:5px 6px;font-size:12px}.iF6NkG_select:focus{border-color:var(--dswsw-accent);box-shadow:0 0 0 3px var(--dswsw-accent-soft)}.iF6NkG_selectWide{width:100%}.iF6NkG_button{border:1px solid var(--dswsw-border);color:var(--dswsw-fg);cursor:pointer;white-space:nowrap;background:0 0;border-radius:7px;flex:none;justify-content:center;align-items:center;gap:6px;padding:5px 13px;font-size:12.5px;font-weight:500;line-height:1.4;display:inline-flex}.iF6NkG_button svg{flex:none}.iF6NkG_button:hover:not(:disabled){background:var(--dswsw-surface-3);border-color:var(--dswsw-border-strong)}.iF6NkG_primary{background:var(--dswsw-accent);border-color:var(--dswsw-accent);color:var(--dswsw-accent-fg)}.iF6NkG_primary:hover:not(:disabled){background:color-mix(in srgb, var(--dswsw-accent) 85%, #fff);border-color:color-mix(in srgb, var(--dswsw-accent) 85%, #fff)}.iF6NkG_button:disabled{opacity:.5;cursor:default}.iF6NkG_iconButton{width:28px;height:28px;color:var(--dswsw-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}.iF6NkG_iconButton:hover:not(:disabled){background:var(--dswsw-surface-3);color:var(--dswsw-fg)}.iF6NkG_iconButton.iF6NkG_danger{color:var(--dswsw-danger-text)}.iF6NkG_iconButton.iF6NkG_danger:hover{background:var(--dswsw-danger-soft);color:var(--dswsw-danger-text)}.iF6NkG_iconButton:disabled{opacity:.45;cursor:default}@media (width<=640px){.iF6NkG_panel{padding:12px}.iF6NkG_card{max-height:calc(100vh - 24px)}}";
		...
		var side_workspaces_module_css_default = {
			"header": "iF6NkG_header",
			"input": "iF6NkG_input",
			"form": "iF6NkG_form",
			"segment": "iF6NkG_segment",
			"rowPath": "iF6NkG_rowPath",
			"card": "iF6NkG_card",
			"action": "iF6NkG_action",
			"row": "iF6NkG_row",
			"panel": "iF6NkG_panel",
			"title": "iF6NkG_title",
			"select": "iF6NkG_select",
			"primary": "iF6NkG_primary",
			"loading": "iF6NkG_loading",
			"selectWide": "iF6NkG_selectWide",
			"list": "iF6NkG_list",
			"button": "iF6NkG_button",
			"rowIcon": "iF6NkG_rowIcon",
			"iconButton": "iF6NkG_iconButton",
			"segmentButton": "iF6NkG_segmentButton",
			"fieldRow": "iF6NkG_fieldRow",
			"segmentButtonOn": "iF6NkG_segmentButtonOn",
			"error": "iF6NkG_error",
			"renameButton": "iF6NkG_renameButton",
			"empty": "iF6NkG_empty",
			"itemLabel": "iF6NkG_itemLabel",
			"danger": "iF6NkG_danger"
		};
		//#endregion
