 ...
 */
export declare function sessionIdOf(context: {
    readonly scope?: object;
}): string | undefined;
/** REQ-I11: the connected-machine ids of one assembly context (empty when unknown). */
export declare function connectedMachineIdsOf(context: {
    readonly scope?: object;
}, store?: () => SessionConnectionsFace | undefined): string[];
/**
 ...
 */
export declare function hasRemoteSessionContext(context: {
    readonly scope?: object;
}, store?: () => SessionSideWorkspaceStore | undefined, connections?: () => SessionConnectionsFace | undefined): boolean;
